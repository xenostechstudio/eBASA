<div class="space-y-6">
    ...
    <div class="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
        ...
        <a href="{{ route('general-setup.retail-products.create') }}" wire:navigate
                ...
                <div class="flex flex-wrap items-center gap-2">
                    ...
                    <div class="relative">
                        <input
                            ...
                            class="w-64 rounded-xl border border-slate-200 bg-slate-50 py-2 pl-10 pr-4 text-sm text-slate-700 placeholder:text-slate-400 focus:border-slate-300 focus:outline-none focus:ring-0 dark:border-white/10 dark:bg-white/5 dark:text-white dark:placeholder:text-white/40"
                        >
                    ...
                    <select
                        ...
                        class="rounded-xl border border-slate-200 bg-slate-50 px-3 py-2 text-sm text-slate-700 focus:border-slate-300 focus:outline-none focus:ring-0 dark:border-white/10 dark:bg-white/5 dark:text-white"
                    >
                            ...
                            <tr class="transition hover:bg-slate-50 dark:hover:bg-white/5">
                                ...
                                <td class="whitespace-nowrap px-5 py-4">
                                    <div class="flex items-center gap-1">
                                        <a href="{{ route('general-setup.retail-products.edit', $product) }}" wire:navigate
