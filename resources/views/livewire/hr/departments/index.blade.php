    ...
    <div class="space-y-6">
        ...
        <div class="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
            ...
            <x-stat.card label="With Lead" :value="number_format($stats['withLead'])" description="Assigned leads" tone="success">
                <x-slot:icon>@svg('heroicon-o-user-circle', 'h-5 w-5 text-emerald-500')</x-slot:icon>
            </x-stat.card>
            ...
            <x-stat.card label="Total Positions" :value="number_format(\App\Models\Position::count())" description="Job roles defined" tone="info">
        ...
        <div class="rounded-2xl border border-slate-300 bg-white shadow-sm dark:border-white/10 dark:bg-white/5">
            ...
            @php $hasActiveFilters = $branchFilter !== 'all'; @endphp
            @if ($hasActiveFilters)
                            ...
                            <tr class="border-b border-slate-100 bg-slate-50 text-left text-xs font-medium uppercase tracking-wider text-slate-500 dark:border-white/10 dark:bg-white/5 dark:text-white/60">
                                ...
                                <th class="px-5 py-3">
                                    <div class="flex items-center gap-1">
                                        LEAD
                                        <span class="text-slate-400" title="Department head or manager">@svg('heroicon-o-information-circle', 'h-3.5 w-3.5')</span>
                                    </div>
                                </th>
                                <th class="px-5 py-3">
                            ...
                            @foreach ($departments as $department)
                                ...
                                >
                                    ...
                                    <td class="whitespace-nowrap px-5 py-4">
                                        ...
                                        @else
                                            <span class="text-xs text-slate-400 dark:text-white/40">Not assigned</span>
                                        @endif
                                    </td>
                                    <td class="whitespace-nowrap px-5 py-4 text-sm text-slate-600 dark:text-white/70">
