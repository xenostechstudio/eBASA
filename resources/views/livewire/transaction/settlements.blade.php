<div class="space-y-6">
    ...
    <div class="grid gap-4 md:grid-cols-3">
        <x-stat.card
            ...
            :value="number_format($stats['totalSettlements'])"
            description="All time closed shifts"
            icon="heroicon-o-banknotes"
            icon-color="text-emerald-500"
        />
        <x-stat.card
            label="Today"
            :value="number_format($stats['todaySettlements'])"
            description="Settlements today"
            icon="heroicon-o-calendar"
            icon-color="text-sky-500"
        />
        <x-stat.card
            label="Cash Collected"
            :value="'Rp ' . number_format($stats['totalCashCollected'], 0, ',', '.')"
            description="Total cash from all settlements"
