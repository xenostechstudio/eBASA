<div class="space-y-6">
    ...
    <div class="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
        <div>
            ...
            <h1 class="mt-2 text-2xl font-bold text-slate-900 dark:text-white">Create Bundle</h1>
            @if ($activeBranch)
                <p class="mt-1 text-sm text-slate-500 dark:text-white/60">Creating bundle for {{ $activeBranch->name }}</p>
            @endif
        </div>
