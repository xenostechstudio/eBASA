    ...
    <div class="rounded-2xl border border-slate-200 bg-white dark:border-white/10 dark:bg-white/5">
        <div class="border-b border-slate-100 px-5 py-4 dark:border-white/10">
            <div class="flex flex-wrap items-center justify-between gap-3">
                ...
                {{-- Create Return --}}
                <a href="{{ route('procurement.returns.create') }}"
                ...
                <table class="w-full">
                    ...
                    <tbody class="divide-y divide-slate-100 dark:divide-white/10">
                        @foreach ($returns as $return)
                            ...
                            @endphp
                            <tr wire:click="goToReturn({{ $return->id }})" class="cursor-pointer transition hover:bg-slate-50 dark:hover:bg-white/5 {{ $isSelected ? 'bg-slate-50 dark:bg-white/5' : '' }}">
